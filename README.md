...
With special recognition to user Xorfor for creating this plugin. Furthermore a recognition to waltervl for his evolution
...
| **OpenAQ API LocationID** | If empty, take from Coordinates, otherwise a StationID (i.e. 9645 (Beidweiler, LU) |
